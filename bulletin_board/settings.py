...
from bulletin_board.local_settings import LOCAL_SECRET_KEY, LOCAL_EMAIL_HOST_USER, LOCAL_EMAIL_HOST_PASSWORD
...
DEFAULT_FROM_EMAIL = "bulletin.board@yandex.ru"

# Надпись в начале темы:
